...
function PaymentsSettingsPageContent({ username }: { username: string }) {
...
export function PaymentsSettingsPage({ username }: { username: string }) {
  return (
    <SalonProvider username={username}>
      <PaymentsSettingsPageContent username={username} />
    </SalonProvider>
  )
}
